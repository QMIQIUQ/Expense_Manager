...
export const translations = {
  ...
  // Grab Earnings Feature
  grabEarnings: { en: 'Grab Earnings', zh: 'Grab 收入', 'zh-CN': 'Grab 收入' },
  grabEarningsHistory: { en: 'Grab Earnings History', zh: 'Grab 收入記錄', 'zh-CN': 'Grab 收入记录' },
  addGrabEarning: { en: 'Add Grab Earning', zh: '新增 Grab 收入', 'zh-CN': '添加 Grab 收入' },
  editGrabEarning: { en: 'Edit Grab Earning', zh: '編輯 Grab 收入', 'zh-CN': '编辑 Grab 收入' },
  ...
  tripReference: { en: 'Trip Reference', zh: '行程編號', 'zh-CN': '行程编号' },
  tripReferenceOptional: { en: 'Trip Reference (Optional)', zh: '行程編號（選填）', 'zh-CN': '行程编号（选填）' },
  payoutDate: { en: 'Payout Date', zh: '付款日期', 'zh-CN': '付款日期' },
  payoutDateOptional: { en: 'Payout Date (Optional)', zh: '付款日期（選填）', 'zh-CN': '付款日期（选填）' },
  payoutReference: { en: 'Payout Reference', zh: '付款參考編號', 'zh-CN': '付款参考编号' },
  payoutReferenceOptional: { en: 'Payout Reference (Optional)', zh: '付款參考編號（選填）', 'zh-CN': '付款参考编号（选填）' },
  noGrabEarningsYet: { en: 'No Grab earnings yet', zh: '尚無 Grab 收入記錄', 'zh-CN': '尚无 Grab 收入记录' },
  startTrackingGrabEarnings: { en: 'Start tracking your Grab earnings by adding your first entry', zh: '新增第一筆記錄以開始追蹤您的 Grab 收入', 'zh-CN': '添加第一笔记录以开始追踪您的 Grab 收入' },
  monthlyGrabEarnings: { en: 'Monthly Grab Earnings', zh: '本月 Grab 收入', 'zh-CN': '本月 Grab 收入' },
  totalGross: { en: 'Total Gross', zh: '總營收', 'zh-CN': '总营收' },
  totalFees: { en: 'Total Fees', zh: '總手續費', 'zh-CN': '总手续费' },
  totalTips: { en: 'Total Tips', zh: '總小費', 'zh-CN': '总小费' },
  totalNet: { en: 'Total Net', zh: '總淨收入', 'zh-CN': '总净收入' },
  tripCount: { en: 'Trip Count', zh: '行程數', 'zh-CN': '行程数' },
  trips: { en: 'trips', zh: '趟', 'zh-CN': '趟' },
  averagePerTrip: { en: 'Avg per Trip', zh: '平均每趟', 'zh-CN': '平均每趟' },
  incomeVsExpense: { en: 'Income vs Expense', zh: '收入 vs 支出', 'zh-CN': '收入 vs 支出' },
  targetAchievement: { en: 'Target Achievement', zh: '目標達成', 'zh-CN': '目标达成' },
  remainingToBreakEven: { en: 'Remaining to Break Even', zh: '距離損益平衡', 'zh-CN': '距离损益平衡' },
  dailyTargetRemaining: { en: 'Daily Target Remaining', zh: '每日所需目標', 'zh-CN': '每日所需目标' },
  daysLeftInMonth: { en: 'Days Left in Month', zh: '本月剩餘天數', 'zh-CN': '本月剩余天数' },
  needToEarnPerDay: { en: 'Need to Earn per Day', zh: '每日需賺取', 'zh-CN': '每日需赚取' },
  targetMet: { en: 'Target Met! 🎉', zh: '目標達成！🎉', 'zh-CN': '目标达成！🎉' },
  surplusThisMonth: { en: 'Surplus This Month', zh: '本月盈餘', 'zh-CN': '本月盈余' },
  grabNetCalculation: { en: 'Net = Gross - Fees + Tips', zh: '淨收入 = 總金額 - 手續費 + 小費', 'zh-CN': '净收入 = 总金额 - 手续费 + 小费' },
  autoCalculated: { en: 'Auto-calculated', zh: '自動計算', 'zh-CN': '自动计算' },
  filterByTripType: { en: 'Filter by Trip Type', zh: '依行程類型篩選', 'zh-CN': '按行程类型筛选' },
  allTripTypes: { en: 'All Trip Types', zh: '所有行程類型', 'zh-CN': '所有行程类型' },
  exportGrabEarnings: { en: 'Export Grab Earnings', zh: '匯出 Grab 收入', 'zh-CN': '导出 Grab 收入' },
  importGrabEarnings: { en: 'Import Grab Earnings', zh: '匯入 Grab 收入', 'zh-CN': '导入 Grab 收入' },
  grabEarningsEnabled: { en: 'Grab Earnings Feature', zh: 'Grab 收入功能', 'zh-CN': 'Grab 收入功能' },
  enableGrabEarnings: { en: 'Enable Grab Earnings', zh: '啟用 Grab 收入', 'zh-CN': '启用 Grab 收入' },
  grabEarningsDescription: { en: 'Track your Grab driver earnings with detailed trip breakdowns', zh: '追蹤您的 Grab 司機收入，詳細的行程明細', 'zh-CN': '追踪您的 Grab 司机收入，详细的行程明细' },
  of: { en: 'of', zh: '的', 'zh-CN': '的' },
  target: { en: 'target', zh: '目標', 'zh-CN': '目标' },
  day: { en: 'day', zh: '天', 'zh-CN': '天' },
