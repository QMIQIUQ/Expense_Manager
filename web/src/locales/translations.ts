...
export const translations = {
  ...
  selectPeriod: { en: 'Select date or period', zh: '選擇日期或期間', 'zh-CN': '选择日期或期间' },
  previousPeriod: { en: 'Previous period', zh: '上一個期間', 'zh-CN': '上一个期间' },
  nextPeriod: { en: 'Next period', zh: '下一個期間', 'zh-CN': '下一个期间' },
  customRange: { en: 'Range', zh: '區間', 'zh-CN': '区间' },
  selectEndDate: { en: 'Select end date', zh: '選擇結束日期', 'zh-CN': '选择结束日期' },
  previousMonth: { en: 'Previous month', zh: '上一個月', 'zh-CN': '上个月' },
  nextMonth: { en: 'Next month', zh: '下一個月', 'zh-CN': '下个月' },
  previousYear: { en: 'Previous year', zh: '上一年', 'zh-CN': '上一年' },
  nextYear: { en: 'Next year', zh: '下一年', 'zh-CN': '下一年' },
  previousYears: { en: 'Previous years', zh: '上一組年份', 'zh-CN': '上一组年份' },
  nextYears: { en: 'Next years', zh: '下一組年份', 'zh-CN': '下一组年份' },
  expandSummary: { en: 'Expand expense overview', zh: '展開支出總覽', 'zh-CN': '展开支出总览' },
  collapseSummary: { en: 'Collapse expense overview', zh: '收起支出總覽', 'zh-CN': '收起支出总览' },
  expandGroup: { en: 'Expand', zh: '展開', 'zh-CN': '展开' },
  collapseGroup: { en: 'Collapse', zh: '收起', 'zh-CN': '收起' },
  ...
  allPaymentMethods: { en: 'All Payment Methods', zh: '所有付款方式', 'zh-CN': '所有付款方式' },
  clearFilters: { en: 'Clear filters', zh: '清除篩選', 'zh-CN': '清除筛选' },
  noFilteredExpenses: { en: 'No expenses match the current filters', zh: '沒有符合目前篩選的支出', 'zh-CN': '没有符合当前筛选的支出' },
